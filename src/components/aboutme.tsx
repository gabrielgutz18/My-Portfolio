  ...
  return (
    <>
     <section className ="aboutme" id ="aboutme">
        ...
        <h2>"I started by untangling cables. Now I build the systems behind them."</h2>
        ...
        <p>m the kind of person who learns by doing, figures things out independently, and doesn't stop until it works. Git, NAS, drones, websites — I pick up whatever the job needs.</p>
     </section>
    </>
  )
}
